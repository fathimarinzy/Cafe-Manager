...
class AppLocalization {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'Main device that holds the database': 'الجهاز الرئيسي الذي يحتوي على قاعدة البيانات',
    'Host / Server': 'المضيف / الخادم',
    'Client': 'العميل',
    'Connects to the Host device': 'يتصل بجهاز المضيف',
    'Searching for Host ON Local Wi-Fi...': 'البحث عن المضيف على شبكة Wi-Fi المحلية...',
    'Connected to Host!': 'متصل بالمضيف!',
    'Manual Connection': 'الاتصال اليدوي',
    'Could not automatically find the Host. Please enter its IP address (e.g., 192.168.1.100).': 'تعذر العثور على المضيف تلقائيًا. يرجى إدخال عنوان IP الخاص به (مثلاً, 192.168.1.100).',
    'Host IP Address': 'عنوان IP للمضيف',
    'Connecting...': 'جارٍ الاتصال...',
    'Connection failed. Check IP and ensure Host is running.': 'فشل الاتصال. تحقق من عنوان IP وتأكد من أن المضيف قيد التشغيل.',
    'Connect': 'اتصال',
    'Is this the Host device or a Client device?': 'هل هذا هو جهاز المضيف أم جهاز العميل؟',
    'Configure Device Sync': 'تكوين مزامنة الجهاز',
    'Last Synced': 'آخر مزامنة',
    'Manual sync triggered': 'تم تشغيل المزامنة اليدوية',
    'Unknown': 'غير معروف',
    'Connected To': 'متصل ب',
    'Starting...': 'جارٍ البدء...',
    'Host Address': 'عنوان المضيف',
    'Offline - Tap to configure': 'غير متصل - اضغط للتكوين',
    'Connected to Host': 'متصل بالمضيف',
